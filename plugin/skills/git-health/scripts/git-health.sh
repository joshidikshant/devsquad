...
# ---- Placeholder: Branch Check (implemented in plan 02) ----
run_branch_check() {
  echo "count=0"
}

# ---- Placeholder: Changes Check (implemented in plan 02) ----
run_changes_check() {
  echo "count=0"
}
  ...
  cat <<JSON
{
  ...
  "checks": {
    ...
    "branches": { "count": ${BRANCH_COUNT}, "issues": [] },
    "changes":  { "count": ${CHANGES_COUNT}, "issues": [] }
  },
